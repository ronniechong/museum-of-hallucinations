  ...
  return (
    <div className="about-content">
      ...
      <p>
        ...
        observability (every generation traced, including token usage and latency), and — in a
        future exhibition — human feedback, as visitors vote on whether an exhibit fooled them.
      </p>
    </div>
  )
}
